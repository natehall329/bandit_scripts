...
procs.names = {'trialproc'};

n = 0;
n = n+1; procs.prefixes{n} = {'showstim',''};
...
%in behavioral, codes are different
q_top   = ( b.stim_RESP == 5 )';
q_left  = ( b.stim_RESP == 4 )';
q_right = ( b.stim_RESP == 6 )';
...
design_struct.rightstim=stims.rightstim;
design_struct.reinforced1=stims.reinforced1;
design_struct.reinforced2=stims.reinforced2;
design_struct.reinforced3=stims.reinforced3;
design_struct.Procedure=b.protocol_type;
...
file_str=[data_dir '/' sprintf('%d/*vrbl*.txt',id)];
dir_tmp = dir(file_str);
file_name=dir_tmp.name;
